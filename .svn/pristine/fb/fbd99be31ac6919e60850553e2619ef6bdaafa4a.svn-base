...
public class JieRuGuanLiActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zhi_neng_jie_ru);
        ...
        list.add(new AnQuanJianChaBean("192.168.50.164", "激活", "移动", "正常量", "正常", "无"));
        list.add(new AnQuanJianChaBean("192.168.60.132", "未激活", "移动", "异常量", "正常", "无"));
        list.add(new AnQuanJianChaBean("192.168.50.184", "激活", "PC", "正常量", "正常", "无"));
        list.add(new AnQuanJianChaBean("192.168.80.151", "激活", "PC", "正常量", "正常", "无"));
        list.add(new AnQuanJianChaBean("192.168.70.123", "未激活", "移动", "异常量", "正常", "无"));
        list.add(new AnQuanJianChaBean("192.168.50.164", "未激活", "PC", "异常量", "正常", "无"));
    ...
    public void onBtnHuangjingjianchaClicked() {
        View contentView = LayoutInflater.from(this).inflate(R.layout.btn_jihuo, null);
        //创建并显示popWindow
    ...
    public void onBtnWenjianpeizhiClicked() {
        View contentView = LayoutInflater.from(this).inflate(R.layout.btn_shebei, null);
        //创建并显示popWindow
        CustomPopWindow mCustomPopWindow = new CustomPopWindow.PopupWindowBuilder(this)
                .setView(contentView)
                .create()
    ...
    public void onBtnZhunrujianchaClicked() {
        View contentView = LayoutInflater.from(this).inflate(R.layout.btn_yongliang, null);
        //创建并显示popWindow
        CustomPopWindow mCustomPopWindow = new CustomPopWindow.PopupWindowBuilder(this)
                .setView(contentView)
                .create()
    ...
    public void onBtnBanbenClicked() {
        View contentView = LayoutInflater.from(this).inflate(R.layout.btn_zifei, null);
        //创建并显示popWindow
        CustomPopWindow mCustomPopWindow = new CustomPopWindow.PopupWindowBuilder(this)
                .setView(contentView)
                .create()
    ...
    public static class AnQuanJianChaAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(mContext).inflate(R.layout.item_jieruguanli, parent, false);
