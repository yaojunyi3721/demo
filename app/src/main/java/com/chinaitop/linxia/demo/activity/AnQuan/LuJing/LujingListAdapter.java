...
public class LujingListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            if (item.type.equals(BaseModel.TYPE_TITLE)) {
                ...
                convertView = LayoutInflater.from(context).inflate(R.layout.work_item_layout, parent, false);
        ...
        if (item.type.equals(BaseModel.TYPE_TITLE)) {
            ...
            itemHolder.tv6.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent=new Intent(context,LujingItem.class);
